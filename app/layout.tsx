    ...
    <html lang="zh-CN" className={inter.variable}>
      <body className="font-inter antialiased">
        <div className="min-h-screen">
          {/* Header */}
          <header className="container max-w-[920px] mx-auto px-10 py-14">
          ...
          {/* Main Content */}
          <main className="container max-w-[920px] mx-auto px-10 pb-14">
            {children}
          </main>

          {/* Footer */}
          <footer className="container max-w-[920px] mx-auto px-10 pb-14">
